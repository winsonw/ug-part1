...
def random_lr(x):
    global last
    print(last)
    last = (1 + (random.random()*0.0012) / 0.00005) / last
    return last
    # return 1
...
def dqn_learing(
    ...
    random_optimizer = optim.lr_scheduler.LambdaLR(optimizer, random_lr)
    ...
    for t in count():
        ...
        if last_obs.shape == (210,160,3) :
            last_obs = process_frame84(last_obs)
        ...
        if (t > learning_starts and
            ...
            # print("ran",random_optimizer.get_lr()[0])
        ...
        if len(episode_rewards) > 0:
            ...
            worst_reward = np.min(episode_rewards[-100:])
        ...
        Statistic["worst_reward"].append(worst_reward)
        ...
        if t % LOG_EVERY_N_STEPS == 0 and t > learning_starts:
            ...
            print("worst reward in 100 episodes %f" % worst_reward)
